...
namespace ICT_SAMS
{
    public partial class Task_Create_Supervisor : Form
    {
        ...
        private void Task_Create_Supervisor_Load(object sender, EventArgs e)
        {
            retrieve();
        }
        ...
        private void comboBox8_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select N from Employeereg";
                command.CommandText = query;
                OleDbDataReader reader = command.ExecuteReader();
                while (reader.Read())
                {
                    comboBox8.Items.Add(reader["N"].ToString());
                }
                con.Close();
            }
            catch (Exception ex)
...
/*
 *  if (textBox1.Text == " " || comboBox6.Text == "" || comboBox7.Text == "")
            {
